"""This script is shamelessly copied from https://github.com/ultralytics/yolov3/blob/0058431e2e8b05b1bdad8ed8e9744c184b6fd4ea/train.py#L59-L62.
Here they load the pretrained weights for darknet53 into PyTorch.
"""
